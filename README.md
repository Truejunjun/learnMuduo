...
EventLoop() → Reactor
{
	ChannelList activeChannels_ (vector<*Channel> 类型)     
	int wakeupFd_    
...
<font color=blue>**TcpConnection**</font>(EventLoop *loop,  string &name,  int sockfd, InetAddress& localAddr_ , InetAddress& peerAddr_)     
